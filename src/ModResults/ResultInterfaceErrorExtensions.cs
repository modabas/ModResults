...
public static class ResultInterfaceErrorExtensions
{
  ...
  /// <returns></returns>
  public static bool IsFailedWith(this IModResult<Failure> result, FailureType failureType)
  {
    return result.IsFailed && result.Failure?.Type == failureType;
  }
  ...
  public static bool IsFailedWith(
    ...
    StringComparison comparisonType = Definitions.DefaultComparisonType)
  {
    return result.IsFailed && result.HasError(errorCode, comparisonType);
  }
  ...
  /// <returns></returns>
  public static bool IsFailedWith<TException>(
    this IModResult<Failure> result,
    bool includeAssignableFrom = false)
    where TException : Exception
  {
